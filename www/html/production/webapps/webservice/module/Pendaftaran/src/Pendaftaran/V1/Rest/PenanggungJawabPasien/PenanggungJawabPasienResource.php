...
class PenanggungJawabPasienResource extends Resource
{
    ...
    public function fetch($id)
    {
		...
		$result =  array(
			...
			"detail" => count($data) > 0 ? "Data Penanggungjawab ditemukan" : "Data Penanggungjawab tidak ditemukan"
		);
    ...
    public function fetchAll($params = array())
    {
		...
		return array(
			...
			"total" => $total,
			"data" => $data,
			"detail" => $total > 0 ? "Data Penanggungjawab ditemukan" : "Data Penanggungjawab tidak ditemukan"
		);
    }
    ...
    public function update($id, $data)
    {
        $result = array(
			...
			"success" => false,
			"data" => null,
			"detail" => "Gagal merubah data penanggungjawab"
		);
		...
		if($canUpdate) {
			...
			if($success) {
				...
				$result["success"] = true;
				$result["data"] = $success[0];
				$result["detail"] = "Berhasil merubah data penanggungjawab";
			}
		}
