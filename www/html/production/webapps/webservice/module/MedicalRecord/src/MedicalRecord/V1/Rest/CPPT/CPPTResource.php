...
class CPPTResource extends Resource
{
    ...
    public function create($data)
    {
		...
		if($success) {
			...
			$result["detail"] = "Berhasil menyimpan CPPT";
		}
    ...
    public function fetch($id)
    {
		...
		$result =  array(
			...
			"detail" => count($data) > 0 ? "CPPT ditemukan" : "CPPT tidak ditemukan"
		);
    ...
    public function fetchAll($params = array())
    {
		...
		return array(
			...
			"total" => $total,
			"data" => $data,
			"detail" => $total > 0 ? "CPPT ditemukan" : "CPPT tidak ditemukan"
		);
    }
    ...
    public function update($id, $data)
    {
        $result = array(
			...
			"success" => false,
			"data" => null,
			"detail" => "Gagal merubah data CPPT"
		);
		...
		if($canUpdate) {
			...
			if($success) {
				...
				$result["success"] = true;
				$result["data"] = $success[0];
				$result["detail"] = "Berhasil merubah data CPPT";
			}
		}
